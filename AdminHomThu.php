...
<head>
    ...
    <title>Hòm Thư</title>
    <link rel="stylesheet" href="./Style/AdminHomThu.css">
                ...
                <div class="mail-box">
                    <?php
                        if ($result->num_rows > 0)
                        {
                            ...
                            {
                                echo "<form action='AdminNoiDungThu.php' method='post'>";

                                echo "<input type='hidden' name='STT' value='".$row['STT']."'>";
                                echo "<button type='submit' class='mail-container'>";
                                echo "<p style='flex-basis: 50%; text-align: start;'><b>Người gửi:</b> ".$row['HoTen']."/<span>".$row['Email']."</span> </p>";
                                echo "<p style='flex-basis: 30%; text-align: start;'><b>Tiêu đề:</b> ".$row['TieuDe']."</p>";
                                echo "<p style='flex-basis: 20%'>".$row['ThoiGian']."</p>";
                                echo "</button>";
                        ...
                        {
                            echo "<h3 style='text-align: center; color: red;'>Hòm thư trống.</h3>";
                        }
                    ?>
                </div>
            </div>
